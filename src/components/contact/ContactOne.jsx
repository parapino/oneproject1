...
export default function ContactOne() {
  return (
    <section className="text-gray-600 dark:text-gray-300 body-font relative bg-white dark:bg-gray-900">
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap ">
        ...
        {/* FORM */}
        <div className="lg:w-1/3 md:w-1/2 bg-white dark:bg-gray-800 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 rounded-lg p-6">
          ...
          <div className="relative mb-4">
            ...
            <textarea
              id="message"
              name="message"
              className="w-full bg-white dark:bg-gray-700 rounded border border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 dark:text-gray-200 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
            ></textarea>
          </div>
